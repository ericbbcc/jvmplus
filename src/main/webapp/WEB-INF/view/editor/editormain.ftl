<div id="hero-unit" style="padding-right:60px;padding-left:60px;">
    ...
    <div id="editor" contenteditable="true" style="overflow:scroll; min-height:300px;border: 1px solid #cccccc;">
    </div>
</div>
